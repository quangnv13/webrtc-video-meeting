...
module.exports = {
  ...
  JWT_SECRET_KEY: process.env.JWT_SECRET_KEY || 'secret_key_default',
  MYSQL_HOST: process.env.MYSQL_HOST || '127.0.0.1',
  MYSQL_PORT: process.env.MYSQL_PORT || 3306,
  MYSQL_USER: process.env.MYSQL_USER || 'root',
  MYSQL_PASSPORT: process.env.MYSQL_PASSPORT || '123456',
  MYSQL_DATABASE: process.env.MYSQL_DATABASE || 'video_meeting',
  PW_SALT: process.env.PW_SALT || '$2b$10$X4kv7j5ZcG39WgogSl16au',
